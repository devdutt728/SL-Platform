...
export async function GET(request: Request) {
  ...
  cookieStore.set("slw_oauth_state", state, { httpOnly: true, sameSite: "lax", secure, path: "/" });
  cookieStore.set("slw_oauth_redirect_uri", redirectUri, { httpOnly: true, sameSite: "lax", secure, path: "/" });
