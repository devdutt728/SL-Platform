...
REPORTS = {
    "candidates": {
        ...
        "columns": {
            ...
            "basic_details_form_token": RecCandidate.basic_details_form_token,
            "basic_details_form_sent_at": RecCandidate.basic_details_form_sent_at,
            "basic_details_form_submitted_at": RecCandidate.basic_details_form_submitted_at,
            "caf_token": RecCandidate.basic_details_form_token,
            "caf_sent_at": RecCandidate.basic_details_form_sent_at,
            "caf_submitted_at": RecCandidate.basic_details_form_submitted_at,
            ...
            "candidate_assessment_form_sent_at": _latest_candidate_value(
                RecCandidateAssessment.candidate_assessment_form_sent_at,
                source_model=RecCandidateAssessment,
                order_by=(RecCandidateAssessment.updated_at.desc(),),
            ),
            "candidate_assessment_form_submitted_at": _latest_candidate_value(
                RecCandidateAssessment.candidate_assessment_form_submitted_at,
                source_model=RecCandidateAssessment,
                order_by=(RecCandidateAssessment.updated_at.desc(),),
            ),
