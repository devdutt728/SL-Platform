...
class RecCandidateAssessment(Base):
    ...
    earliest_joining_date: Mapped[date | None] = mapped_column(Date, nullable=True)
    current_ctc_annual: Mapped[float | None] = mapped_column(Numeric(12, 2), nullable=True)
    current_monthly_take_home: Mapped[float | None] = mapped_column(Numeric(12, 2), nullable=True)
