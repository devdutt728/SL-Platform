...
if not defined IT_FRONTEND_ERR_LOG set "IT_FRONTEND_ERR_LOG=%LOGDIR%\it-frontend.err.log"
if not defined REC_FRONTEND_ERR_LOG set "REC_FRONTEND_ERR_LOG=%LOGDIR%\recruitment-frontend.err.log"
if not defined WORKBOOK_ERR_LOG set "WORKBOOK_ERR_LOG=%LOGDIR%\workbook-frontend.err.log"
if not defined IT_FRONTEND_BUILD_LOG set "IT_FRONTEND_BUILD_LOG=%LOGDIR%\it-frontend-build.log"
if not defined IT_FRONTEND_BUILD_ERR_LOG set "IT_FRONTEND_BUILD_ERR_LOG=%LOGDIR%\it-frontend-build.err.log"
if not defined REC_FRONTEND_BUILD_LOG set "REC_FRONTEND_BUILD_LOG=%LOGDIR%\recruitment-frontend-build.log"
if not defined REC_FRONTEND_BUILD_ERR_LOG set "REC_FRONTEND_BUILD_ERR_LOG=%LOGDIR%\recruitment-frontend-build.err.log"
if not defined WORKBOOK_BUILD_LOG set "WORKBOOK_BUILD_LOG=%LOGDIR%\workbook-frontend-build.log"
if not defined WORKBOOK_BUILD_ERR_LOG set "WORKBOOK_BUILD_ERR_LOG=%LOGDIR%\workbook-frontend-build.err.log"
